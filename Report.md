...
- Twin Delayed Deep Deterministic Policy Gradients (TD3), a successor to DDPG. [Paper](https://arxiv.org/abs/1802.09477)
- Soft Actor-Critic (SAC), which is one of the most advanced actor critic methods. [Paper](https://arxiv.org/abs/1801.01290)
